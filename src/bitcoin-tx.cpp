...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Aikrw Core aikrw-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aikrw-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aikrw transaction") + "\n" +
              "  aikrw-tx [options] -create [commands]   " + _("Create hex-encoded aikrw transaction") + "\n" +
              "\n";
