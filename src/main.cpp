...
#if defined(NDEBUG)
# error "Aikrw cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Aikrw Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Aikrw: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet & regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Aikrw: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
